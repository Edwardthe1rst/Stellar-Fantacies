...
_Prerequisite: Melee Dualist feat._
...
_Prerequisites: Melee Dualist feat._
...
_Prerequisite: Pin Deal unarmed damage to a pinned target._
...
_Prerequisites: Master Disarmer_
...
_Prerequisite: Mystic Intuition_
...
_Prerequisite: Improved Sustainer I_
...
_Prerequisite: Inspire & Bolster Ally_
...
_Prerequisites: Knack, Lucky Shot_
...
_Prerequisite: Improved Stealth_
...
_Prerequisites: Hidden Movement, Improved Stealth_
...
_Prerequisite: Uncanny Dodge II_
...
_Prerequisite: Harms Way. If the attack’s target is within half of your movement speed, you can move next to them in order to take the damage._
...
_Prerequisite: Suppression Fire feat. When you use the Suppression Fire feat, the targets suffer an additional -2 to their attack rolls. You can take this talent up to 3 times._
...
_Prerequisite: Weapon Specialization_
...
_Prerequisites: Critical Skill Success_
...
_Prerequisites: Trained in Treat Injury_
...
_Prerequisites: Trained in Knowledge (Technology) skill_
...
_Prerequisite: Trained in Use Computer_
...
_Prerequisite: Trained in Mechanics_
...
_Prerequisites: Electronic Sabotage, Trained in Use Computer_
...
- _Prerequisite_: Telekinesis Specialization
...
- _Prerequisite_: Sorcery Specialization
...
- With _Jury Rig_ talent, install as 2 standard + 2 swift actions. Temporary until end of encounter.
...
Once you find someone who can acquire the item for you, you'll have to pay two, three, four, or five times the item's normal price (as listed in the _Black Market Cost_ column of the _Restricted Items_ table). You will also have to wait some time for the item to become available (as listed in the _Time Required_ column).
...
- **Piercing:** Some physical damage is piercing, which partially ignores damage reduction (see _Piercing_ weapon quality and _Damage Reduction_ armor quality).
...
It represents _attack actions_, not necessarily projectiles. It may indicate bursts, sustained fire, or individual shots, depending on weapon flavor.
...
- While equipped, you can use the _Duck Behind_ free action without cover (instead of the normal _Dodge_ Swift Action).

- As an action, the item can be raised to act as half cover, granting **+5 Reflex Defense** until your next action.

**Delay**

Targets of an attack with the _Delay_ quality (including AOE effects) may use a number of actions equal to the delay value.
...
- Stun range is always _close_, regardless of weapon range.
...
- Some armor has limited availability (see _Rare_).
...
- **Lightsaber Resistant:** Armor with the _Energy Kyber_ quality reduces damage from kyber sources (e.g., lightsabers), which normally ignore DR.
